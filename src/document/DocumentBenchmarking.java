...
public class DocumentBenchmarking {
	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			...
			BasicDocument testBasic = new BasicDocument(test);
			double fleschScore = testBasic.getFleschScore();
			...
			EfficientDocument testEffic = new EfficientDocument(test);
			fleschScore = testEffic.getFleschScore();
